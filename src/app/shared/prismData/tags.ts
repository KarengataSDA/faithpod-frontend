...
export let tagsHTML9 = 
`<div class="example">
<div class="tags">
    <span class="tag">
            <span><img src="./assets/images/users/11.jpg" class="tag-avatar avatar cover-image"></span> Victoria
    </span>
    <span class="tag">
            <span><img src="./assets/images/users/4.jpg" class="tag-avatar avatar cover-image"></span> Nathan
    </span>
    <span class="tag">
            <span><img src="./assets/images/users/1.jpg" class="tag-avatar avatar cover-image"></span> Alice
    </span>
    <span class="tag">
            <span ><img src="./assets/images/users/18.jpg" class="tag-avatar avatar cover-image"></span> Rose
    </span>
    <span class="tag">
            <span ><img src="./assets/images/users/16.jpg" class="tag-avatar avatar cover-image"></span> Peter
    </span>
    <span class="tag">
            <span><img src="./assets/images/users/6.jpg" class="tag-avatar avatar cover-image"></span> Wayne
    </span>
    <span class="tag">
            <span><img src="./assets/images/users/7.jpg" class="tag-avatar avatar cover-image"></span> Michelle
    </span>
    <span class="tag">
            <span ><img src="./assets/images/users/17.jpg" class="tag-avatar avatar cover-image"></span> Debra
    </span>
</div>
</div>`
export let tagsHTML10 = 
`<div class="example">
<div class="tags">
    <span class="tag">First tag</span>
    <span class="tag">Second tag</span>
